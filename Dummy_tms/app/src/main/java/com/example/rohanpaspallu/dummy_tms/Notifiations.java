...
public class Notifiations extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notifiations);
...
//        });
        ...
        pdialog= new ProgressDialog(Notifiations.this);
        pdialog.setMessage("Loading...");
        pdialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.43.88/admin_panel/webservice/display_notification.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            for (int j = 0; j < user1.length(); j++) {
                                ...
                                GetDataAdapter2.setId(c.getString("Sr_no"));
                                GetDataAdapter2.setName(c.getString("Title"));
                                GetDataAdapter2.setCountry(c.getString("Desc"));
                                GetDataAdapter2.setDiscount(c.getString("image"));
                                GetDataAdapter2.setLatitute(c.getString("date"));
                                ...
                                recyclerViewadapter = new Notification_adapter(GetDataAdapter1, getApplicationContext());
